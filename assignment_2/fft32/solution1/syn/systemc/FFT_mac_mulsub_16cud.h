...
#ifndef __FFT_mac_mulsub_16cud__HH__
#define __FFT_mac_mulsub_16cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_mac_mulsub_16cud) {
    ...
    SC_CTOR(FFT_mac_mulsub_16cud):  simcore_mac_0_U ("simcore_mac_0_U") {
