...
HD_PWD='D:/1_EE5332/assignment_2/perf_ctr/perf_ctr.runs/mb_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lmb_bram_0.tcl
