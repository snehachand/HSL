...
HD_PWD='D:/1_EE5332/assignment_3/perf_ctr/perf_ctr.runs/mb_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_mdm_1_0.tcl
